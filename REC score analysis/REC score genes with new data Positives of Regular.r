...
write.table(orderedREC, "Ordered Gene REC Scores Positives Regular.txt", sep="\t", quote=FALSE)
...
setwd("F:/Bioinformatics Lab/Cancer Data/REC Score Analysis/Regular")
write.table(totalranks, "ranks in each cancer of each gene FIX Regular Pos.txt", sep="\t", quote=FALSE)
