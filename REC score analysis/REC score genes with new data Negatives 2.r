...
tresults<- t(results)
setwd("E:/Bioinformatics Lab/Cancer Data/REC Score Analysis 3/REC score no cancer")
orderedREC<- tresults[order(tresults[,c("REC")]),, drop=FALSE]
write.table(orderedREC, "Ordered Gene REC Scores Negative 4.txt", sep="\t", quote=FALSE)
...
setwd("E:/Bioinformatics Lab/Cancer Data/REC Score Analysis 3/REC score no cancer")
write.table(totalranks, "ranks in each cancer of each gene FIX Neg 4.txt", sep="\t", quote=FALSE)
