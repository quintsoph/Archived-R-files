...
#read in files
setwd("E:/Bioinformatics Lab/Cancer Data/REC Score Analysis /results.miRNA.log2/BLCA")
...
UCECNA2<- data.frame(c(2,1))
rownames(UCECNA2)=rownames(UCECNA1)
colnames(UCECNA2)= c("UCEC")
UCECr<- nrow(UCECNA2)
L<- cbind(UCECr, L)
...
write.table(orderedREC, "OrderedREC miRNA neg new data2.txt", quote=FALSE, sep="\t")
