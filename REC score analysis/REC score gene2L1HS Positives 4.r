...
write.table(orderedREC, "Ordered Gene REC Scores Positives 4.txt", sep="\t", quote=FALSE)
...
setwd("E:/Bioinformatics Lab/Cancer Data/REC Score Analysis 4/gene2L1HS")
write.table(totalranks, "ranks in each cancer of each gene Pos 4.txt", sep="\t", quote=FALSE)
